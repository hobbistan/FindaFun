 ...
 */
public class LeaderCityBoardFragment extends Fragment implements IGamificationServiceListener {
    ...
    private DataAdapter_City mAdapter = null;
    private ProgressDialog mProgressDialog = null;
    private android.os.Handler mHandler = new android.os.Handler();


    public LeaderCityBoardFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_leader_city_board, container, false);
    ...
    class DataAdapter_City extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (FindAFunValidator.checkNullString(board.getUserImageUrl())) {
                Picasso.with(getActivity()).load(board.getUserImageUrl()).fit().transform(LeaderCityBoardFragment.this.transformation).placeholder(R.drawable.placeholder_small_old).error(R.drawable.placeholder_small_old).into(userimage);
            } else {
