 ...
 */
public class LocalLeaderBoardActivity extends AppCompatActivity implements IGamificationServiceListener, DialogClickListener {

    private static final String TAG = LocalLeaderBoardActivity.class.getName();
    ...
    private DataAdapter_local mAdapter = null;
    private ProgressDialog mProgressDialog = null;
    private android.os.Handler mHandler = new android.os.Handler();

    public LocalLeaderBoardActivity() {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_leader_city_board);

        mLeaderboardList = (ListView) findViewById(R.id.local_leader_board_list);
        mAdapter = new DataAdapter_local();
        ...
        helper.fetchLeaderBoardDetails(String.format(FindAFunConstants.GET_LOCAL_LEADER_BOARD,cityName), this);
    ...
    class DataAdapter_local extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (FindAFunValidator.checkNullString(board.getUserImageUrl())) {
                Picasso.with(LocalLeaderBoardActivity.this).load(board.getUserImageUrl()).fit().transform(LocalLeaderBoardActivity.this.transformation).placeholder(R.drawable.placeholder_small_old).error(R.drawable.placeholder_small_old).into(userimage);
            } else {
